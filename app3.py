                    ...
                    dcc.Tab(label='ANN MODELING', children=[
                        ...
                        html.Div([
                            html.Div(className='row',children=[
                                ...
                                dcc.Input(id="input4", type="Text", placeholder="Input Nodes :",value='bedrooms,bathrooms,sqft_living,sqft_lot,floors,waterfront,view,condition,grade,sqft_above,sqft_basement,yr_built,yr_renovated,lat,long,sqft_living15,sqft_lot15,month,year'),
                                html.P(),
                                dcc.Input(id="input_1", type="Text", placeholder="Output Nodes :", value = 'price'),
                                html.P(),
                                #html.H6("Scaler:"),
                                #html.Div([
                                #    dcc.Dropdown(
